	...
	public class Light2DEditor : Editor
	{
		...
		private bool OnScene_FreeForm()
		{
			...
			for(int i = 0; i < points.Count; i++)
			{
				...
				var fmh_201_52_638328131849845873 = Quaternion.identity; Vector3 result = Handles.FreeMoveHandle(point, 0.05f * cameraSize, Vector2.zero, Handles.CylinderHandleCap);
		...
		private bool OnScene_Point()
		{
			...
			var fmh_255_51_638328131849862593 = Quaternion.identity; Vector3 result = Handles.FreeMoveHandle(point, 0.05f * cameraSize, Vector2.zero, Handles.CylinderHandleCap);
			...
			var fmh_298_61_638328131849864658 = Quaternion.identity; Vector3 innerHandle = Handles.FreeMoveHandle(innerPoint, 0.05f * cameraSize, Vector2.zero, Handles.CylinderHandleCap);
			...
			if (light2D.spotAngleInner < 360)
			{
				...
				var fmh_336_70_638328131849866316 = Quaternion.identity; Vector3 outerHandleLeft = Handles.FreeMoveHandle(outerPointLeft, 0.05f * cameraSize, Vector2.zero, Handles.CylinderHandleCap);
				...
				var fmh_362_72_638328131849867937 = Quaternion.identity; Vector3 outerHandleRight = Handles.FreeMoveHandle(outerPointRight, 0.05f * cameraSize, Vector2.zero, Handles.CylinderHandleCap);
